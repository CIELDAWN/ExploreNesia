...
<body class="bg-gray-50">
    ...
    <div class="fixed inset-y-0 left-0 w-64 bg-white shadow-xl z-50">
        ...
        <nav class="mt-6 px-4">
            ...
            <a href="{{ route('mitra.destinations.index') }}" class="sidebar-link flex items-center gap-3 px-4 py-3 rounded-lg text-gray-700 hover:bg-ocean-50 {{ request()->routeIs('mitra.destinations.*') ? 'active text-white' : '' }}">
