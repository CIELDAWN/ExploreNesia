        ...
        <div class="w-full lg:w-1/2 flex items-center justify-center p-8">
            <div class="w-full max-w-md">
                ...
                <div class="bg-white rounded-2xl shadow-xl p-8">
                    ...
                    <!-- Account Deactivated Alert (Special Style) -->
                    @if ($errors->has('email') && str_contains($errors->first('email'), 'dinonaktifkan'))
                    <div class="mb-6 bg-gradient-to-r from-red-500 to-red-600 text-white rounded-xl shadow-lg p-5 shake-animation">
                        <div class="flex items-start gap-4">
                            ...
                            <div class="flex-1">
                                <h4 class="font-bold text-lg mb-2">Akun Dinonaktifkan</h4>
                                <p class="text-sm mb-3 leading-relaxed">
                                    {{ $errors->first('email') }}
                                </p>
                                <div class="flex items-center gap-2 text-sm bg-white bg-opacity-20 rounded-lg p-3">
                                    <i class="fas fa-info-circle"></i>
                                    <span>Akun anda telah dinonaktifkan silahkan hubungi Admin</span>
                                </div>
                                <div class="mt-3 pt-3 border-t border-white border-opacity-20">
                                    <p class="text-xs opacity-90">
                                        <i class="fas fa-envelope mr-1"></i>
                                        Email: support@explorenesia.com
                                    </p>
                    ...
                    <!-- Regular Error Messages (Other errors) -->
                    @elseif ($errors->any())
